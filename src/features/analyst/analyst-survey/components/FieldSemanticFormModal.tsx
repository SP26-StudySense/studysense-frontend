...
import type { SurveyFieldSemantic, FieldSemanticFormData } from "../types";

interface FieldSemanticFormModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function FieldSemanticFormModal({
  isOpen,
  onClose,
  onSubmit,
  initialData,
  mode,
}: FieldSemanticFormModalProps) {
