...
export default function RoadmapsLayout({
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#f0fffe] via-[#faf5fc] to-[#f0fffe] font-sans text-neutral-900 selection:bg-[#00bae2] selection:text-white overflow-hidden flex flex-col">
            {/* Background Effects */}
            ...
            <main className="relative z-10 container mx-auto flex-1 px-6 pt-24 pb-16 max-w-7xl">
                {children}
            </main>
