...
export default function RoadmapDetailPage({ params }: { params: { id: string } }) {
  // In production, fetch roadmap data based on params.id
  console.log("Roadmap ID:", params.id);
  
  return <AdminRoadmapPage initialNodes={MOCK_NODES} initialEdges={MOCK_EDGES} />;
}
